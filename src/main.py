...
model=Multimodality_TCN(no_outer=4)
model.load_state_dict(torch.load("results/models/strong/strong_multi_tcn_checkpoint.pt"))
...
#     parser.add_argument('--no_outer', default=0, type=float, help='number of outers')
...
#     main(model_name=args.breath_type+'_'+args.model_type+'_'+args.model_name, Model=Model,
